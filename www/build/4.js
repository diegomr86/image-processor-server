...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__guide_form__ = __webpack_require__(578);
...
var GuideFormPage = /** @class */ (function () {
    function GuideFormPage(navCtrl, toastCtrl, formBuilder, database, api, utils, params) {
        ...
        this.form = formBuilder.group({
            type: ['guide', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required],
    ...
    GuideFormPage.prototype.delete = function (guide) {
        ...
        this.utils.showConfirm(function () {
            _this.database.remove(guide).then(function (res) {
