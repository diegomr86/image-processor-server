...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__login__ = __webpack_require__(546);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers__ = __webpack_require__(146);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_utils__ = __webpack_require__(285);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5____ = __webpack_require__(286);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LoginPage = /** @class */ (function () {
    function LoginPage(navCtrl, user, toastCtrl, formBuilder, utils) {
        var _this = this;
        ...
        this.form = formBuilder.group({
            _id: ['', __WEBPACK_IMPORTED_MODULE_2__angular_forms__["j" /* Validators */].required]
        });
    ...
    LoginPage.prototype.login = function () {
        ...
        this.user.login(this.form.controls._id.value).then(function (resp) {
            ...
            if (e.name == 'not_found') {
                _this.utils.showToast('Usuário não encontrado! Por favor cadastre-se.', 'error');
            }
            console.log(e);
        });
    };
