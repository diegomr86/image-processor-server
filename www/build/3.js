...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ngx_chips__ = __webpack_require__(562);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__plant_form__ = __webpack_require__(587);
...
var PlantFormPage = /** @class */ (function () {
    function PlantFormPage(navCtrl, toastCtrl, formBuilder, camera, database, api, utils, params) {
        ...
        this.form = formBuilder.group({
            type: ['plant', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required],
        ...
        this.database.loadAdditionalFields('plant').then(function (res) {
    ...
    PlantFormPage.prototype.delete = function (plant) {
        ...
        this.utils.showConfirm(function () {
            _this.database.remove(plant).then(function (res) {
