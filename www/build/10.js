...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__welcome__ = __webpack_require__(563);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_facebook__ = __webpack_require__(291);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_google_plus__ = __webpack_require__(292);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers__ = __webpack_require__(146);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages__ = __webpack_require__(286);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var WelcomePage = /** @class */ (function () {
    function WelcomePage(navCtrl, fb, googlePlus, user) {
    ...
    WelcomePage.prototype.facebookLogin = function () {
        ...
        this.fb.login(['public_profile', 'email'])
            ...
            _this.fb.api("me?fields=id,name,email,first_name,picture.width(320).height(320).as(picture_large)", []).then(function (user) {
                _this.user.signup({ type: 'user', _id: user.email, name: user.name, picture: user.picture_large.data.url, facebook_id: user.id }).then(function (resp) {
                    _this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_5__pages__["b" /* MainPage */]);
                }).catch(function (e) {
                    if (e.name == 'conflict') {
                        _this.user.login(user.email).then(function (resp) {
                            if (resp) {
                                _this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_5__pages__["b" /* MainPage */]);
                            }
                        });
    ...
    WelcomePage.prototype.googleLogin = function () {
        ...
        this.googlePlus.login()
            .then(function (user) {
            _this.user.signup({ type: 'user', _id: user.email, name: user.displayName, picture: user.imageUrl, google_id: user.userId }).then(function (resp) {
                _this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_5__pages__["b" /* MainPage */]);
            }).catch(function (e) {
                if (e.name == 'conflict') {
                    _this.user.login(user.email).then(function (resp) {
    ...
    WelcomePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_facebook__["a" /* Facebook */], __WEBPACK_IMPORTED_MODULE_3__ionic_native_google_plus__["a" /* GooglePlus */], __WEBPACK_IMPORTED_MODULE_4__providers__["d" /* User */]])
    ], WelcomePage);
    return WelcomePage;
}());
