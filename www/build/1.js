...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__topic_form__ = __webpack_require__(598);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ngx_quill__ = __webpack_require__(533);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_components_module__ = __webpack_require__(534);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ngx_chips__ = __webpack_require__(562);
...
var TopicFormPage = /** @class */ (function () {
    function TopicFormPage(navCtrl, toastCtrl, formBuilder, database, api, utils, params) {
        ...
        this.form = formBuilder.group({
            type: ['topic', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required],
            user_id: [database.currentUser._id, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["j" /* Validators */].required],
            _id: [''],
            $id: [''],
    ...
    TopicFormPage.prototype.delete = function (topic) {
        ...
        this.utils.showConfirm(function () {
            _this.database.remove(topic).then(function (res) {
    ...
    TopicFormPage.prototype.save = function () {
        ...
        this.utils.showConfirm(function () {
            ...
            if (!_this.form.controls._id) {
                _this.form.patchValue({ comments: [{ user_id: _this.database.currentUser._id, message: _this.form.controls.content.value, created_at: new Date() }] });
            }
            console.log('this.form.value', _this.form.value);
            _this.database.save(_this.form.value).then(function (res) {
                _this.navCtrl.setRoot('ForumPage');
                _this.navCtrl.push('TopicPage', { id: res.id });
            }).catch(function (e) {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* ViewChild */])('fileInput'),
        __metadata("design:type", Object)
    ], TopicFormPage.prototype, "fileInput", void 0);
